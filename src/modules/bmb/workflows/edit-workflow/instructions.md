...
<critical>You MUST have already loaded and processed: {bmad_folder}/bmb/workflows/edit-workflow/workflow.yaml</critical>
...
- Study example workflows from: {bmad_folder}/bmm/workflows/
  </action>

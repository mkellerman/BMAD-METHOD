...
<!-- Standard workflow -->
<item cmd="*create-prd"
     run-workflow="{bmad_folder}/bmm/workflows/prd/workflow.yaml">
...
<!-- Simple task -->
<item cmd="*validate"
   exec="{bmad_folder}/core/tasks/validate-workflow.xml">
  Validate document against checklist
</item>

<!-- Task with data -->
<item cmd="*standup"
   exec="{bmad_folder}/mmm/tasks/daily-standup.xml"
...
<item cmd="*competitor-analysis"
   exec="{bmad_folder}/core/tasks/create-doc.md"
   tmpl="{bmad_folder}/bmm/templates/competitor.md"
   data="{bmad_folder}/_data/market-research.csv">
...
<item cmd="*list-tasks"
   action="list all tasks from {bmad_folder}/_cfg/task-manifest.csv">
...
<agent name="Research Assistant">
  ...
  <menu>
    ...
    <item cmd="*review-literature"
       ...
       data="{bmad_folder}/_data/sources.csv">
...
<!-- Workflow with data -->
<item cmd="*brainstorm"
   run-workflow="{bmad_folder}/core/workflows/brainstorming/workflow.yaml"
   data="{bmad_folder}/core/workflows/brainstorming/brain-methods.csv">
...
<item cmd="*analyze-metrics"
   ...
   data="{bmad_folder}/_data/performance-metrics.json">
...
<item cmd="*report"
   exec="{bmad_folder}/core/tasks/create-doc.md"
   tmpl="{bmad_folder}/bmm/templates/report.md"
   data="{bmad_folder}/_data/quarterly-results.csv">
...
<item cmd="*{action}-{object}"
   run-workflow="{bmad_folder}/{module}/workflows/{workflow}/workflow.yaml">
...
<item cmd="*validate-{object}"
   validate-workflow="{output_folder}/{document}.md"
   workflow="{bmad_folder}/{module}/workflows/{workflow}/workflow.yaml">
...
```xml
<item cmd="*{action}"
   exec="{bmad_folder}/{module}/tasks/{task}.md">
  {Action Description}
</item>
```
...
<item cmd="*{document}"
   exec="{bmad_folder}/core/tasks/create-doc.md"
   tmpl="{bmad_folder}/{module}/templates/{template}.md">
...
<agent id="{bmad_folder}/research/agents/analyst.md" name="Research Analyst" icon="🔬">
  ...
  <menu>
    ...
    <item cmd="*compete"
       ...
       data="{bmad_folder}/_data/market-data.csv">
      Analyze Competition
    </item>
    ...
    <item cmd="*report"
       exec="{bmad_folder}/core/tasks/create-doc.md"
       tmpl="{bmad_folder}/research/templates/report.md">
...
<agent name="Data Analyst">
  <menu>
    ...
    <item cmd="*analyze"
       ...
       data="{bmad_folder}/_data/dataset.csv">
      Analyze Dataset
    </item>

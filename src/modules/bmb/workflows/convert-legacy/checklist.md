...
- [ ] ALL paths reference {bmad_folder}/{{module}}/ locations, NOT src/
...
- [ ] Elicitation points (elicit: true) converted to <invoke-task halt="true">{bmad_folder}/core/tasks/adv-elicit.xml</invoke-task>
